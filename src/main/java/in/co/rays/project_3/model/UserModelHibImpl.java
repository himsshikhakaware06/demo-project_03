...
public class UserModelHibImpl implements UserModelInt{
	...
	public long add(UserDTO dto) throws DuplicateRecordException, ApplicationException {
		...
		log.debug("UserModle add started");
		long pk=0;
	...
	public void delete(UserDTO dto) throws DuplicateRecordException, ApplicationException {
		...
		try {
			...
			throw new ApplicationException("Exception in User DeleteHibImpl" + e.getMessage());
		}
		finally{
			session.close();
		}
	...
	public List search(UserDTO dto, int pageNo, int pageSize) throws ApplicationException {
		...
		try {
			...
			// TODO: handle exception
			throw new ApplicationException("exception in userHibImpl search");
